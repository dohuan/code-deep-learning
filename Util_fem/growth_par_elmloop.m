function out = growth_par_elmloop(damage_params, days,k_sigma_f, k_sigma_m, name, length, n_dt, print_step, kc, P_a, r_h, H_h, nu_e0, nu_f0, nu_m0, phi0, G_h, G_e, G_m, Sa, La_M, La_0, sigma_f0, sigma_m0, n_elm, kq_c, kq_m, age_max, op_time,Le_low)
        ...
        while ( itnum <= max_itr & itr_error > tol)
            ...
            for elm=1:n_elm
                ...
                for k=1:n_Gauss_pt
                    ...
                    Me = Me0*damage(Z, damage_params)*Q_dmg_e(Ln_e1,Ln_e2,Le_low);
                    Mt = Mt+Me;
